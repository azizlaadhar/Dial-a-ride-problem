...
parameters = [['0', 'a', 2, 16, 480, 3, 30], # 0
              ...
              ['0', 'a', 2, 16, 480, 3, 30],  # 8
              ['0', 'a', 2, 16, 480, 3, 30],  # 9
              ['0', 'a', 2, 16, 480, 3, 30],  # 10
              ['0', 'a', 2, 16, 480, 3, 30],  # 11
              ['0', 'a', 2, 16, 480, 3, 30],  # 12
              ['0', 'a', 2, 16, 480, 3, 30],  # 13
              ['0', 'a', 2, 16, 480, 3, 30],  # 14
              ['0', 'a', 2, 16, 480, 3, 30]]  # 15
...
def main():
    ...
    checkpoint = torch.load('./model/model-b3-24RL.model')
